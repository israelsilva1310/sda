        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-2 hidden-sm hidden-xs">
                    <div class="logo">
                        <a href="index.html"><img src="img/apnew/logo/logo-3.png" alt="APNEW"/></a>
                    </div>
                </div>
...
<!--End of Header Area-->
<!--Banner Area Start-->
<div class="banner-area banner-yellow banner-horizontal" id="banner">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-8 col-sm-8 col-xs-12">
                <div class="banner-text">
                    <div class="banner-table-cell">
                        <h1>TCC<br><span>SDA</span> Web APP.</h1>
                        ...
                        <div class="banner-buttons">
                            <?= $this->Form->button('Cadastrar', ['class' => 'button-default button-yellow'], ['controller' => 'Users', 'action' => 'add']) ?>
                            <a href="<?= $this->Url->build([
                                'controller' => 'Users',
                                'action' => 'login',
                            ]) ?>" class="button-default button-white">Fazer Login</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5 col-md-4 col-sm-4 hidden-xs">
                <div class="banner-product-image">
                    <div class="wow bounceInUp" data-wow-duration="2s" data-wow-delay="0s">
                        <img src="img/apnew/banner-yellow/banner599x956.png" alt="" class="floatright">
                    </div>
                </div>
            </div>
        </div>
...
<!--End of Banner Area-->
<!--About Area Start-->
<div class="about-area about-yellow horizontal" id="about">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title text-center title-yellow">
                    <h1>ABOUT <span>APNEW</span></h1>
                    <img src="img/apnew/icon/title-icon-yellow.png" alt="">
        ...
        <div class="row">
            <div class="col-lg-5 col-lg-offset-1 col-md-5 col-md-offset-0 col-sm-5 col-sm-offset-0">
                <div class="about-image wow fadeInLeft" data-wow-duration="3s" data-wow-delay="0s">
                    <img src="img/apnew/banner-yellow/mobile.png" alt="" class="floatright">
                </div>
            </div>
            <div class="col-lg-6 col-md-7 col-sm-7 col-xs-12">
                <div class="about-text">
                    ...
                    <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was
                        ...
                        the great explorer of the truth, the master of human happiness. No one rejects, dislikes,</p>
                    <p>mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete
                        account of the system, and expound the </p>
...
<!--End of About Area-->
<!--Service Area Start-->
<div class="service-area service-yellow hidden-xs horizontal">
    <div class="container">
        <div class="row">
...
<!--End of Service Area-->
<!--Features Area Start-->
<div class="features-area features-yellow hidden-xs horizontal" id="features">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title text-center title-yellow">
            ...
            <div class="col-lg-7 col-lg-offset-5 col-md-9 col-md-offset-3 col-sm-12 col-sm-offset-0 feature-wrapper">
                <div class="single-item">
                    ...
                    <div class="single-item-text">
                        ...
                        <p>There are many variations of passages of Lorem Ipsum available,but the majorityhave suffered
                            alteration in some form, by injected humour,available</p>
                    </div>
                </div>
                <div class="single-item">
                    <div class="single-item-icon">
                ...
                <div class="single-item">
                    ...
                    <div class="single-item-text">
                        <h4>Unique Design</h4>
                        <p>There are many variations of passages of Lorem Ipsumavailable,but the majorityhave suffered
                            alteration in some form, by injected humour,available</p>
                    </div>
                </div>
                <div class="single-item">
...
<!--Download Area Start-->
<div class="download-area download-yellow horizontal">
...
<!--Pricing Area Start-->
<div class="pricing-area pricing-yellow horizontal" id="pricing">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title text-center title-yellow">
...
<div class="testimonial-area testimonial-yellow horizontal" id="reviews">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title text-center title-yellow">
...
<div class="screenshots-area screenshots-yellow horizontal" id="screenshots">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title text-center title-yellow">
